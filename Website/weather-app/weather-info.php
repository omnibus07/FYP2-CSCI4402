            ...
            <div class="card h-100 shadow-sm">
                <div class="card-body" style="background-color: #0f0558; color: white; border-radius: 8px;">
                    ...
                    <div class="position-relative">
                        <img src="./images/edu_weather_terminology.png" alt="Weather Terminology"
                            class="img-fluid rounded mb-2" style="width: 100%; height: auto; object-fit: cover;">
        ...
        <div class="col-md-3">
            <div class="card h-100 shadow-sm">
                <div class="card-body" style="border-radius: 8px;">
                    ...
                    <img src="./images/edu_type_of_extreme_weather.png" alt="Extreme Weather Types"
                        class="img-fluid rounded mb-2" style="width: 100%; height: auto; object-fit: cover;">
                </div>
            </div>
        </div>

        <!-- Tropical Storms Card -->
        <div class="col-md-3">
            <div class="card h-100 shadow-sm">
                <div class="card-body" style="border-radius: 8px;">
                    <h5 class="card-title mb-3">Formation of Tropical Storms</h5>
                    <img src="./images/edut_formation_of_tropical_storms.png" alt="Tropical Storms Formation"
                        class="img-fluid rounded mb-2" style="width: 100%; height: auto; object-fit: cover;">
                </div>
            </div>
        </div>

        <!-- Precipitation Types Card -->
        <div class="col-md-3">
            <div class="card h-100 shadow-sm">
                <div class="card-body" style="border-radius: 8px;">
                    <h5 class="card-title mb-3">The Role of Water</h5>
                    <img src="./images/edu_the_role_of_water.png" alt="Types of Precipitation"
                        class="img-fluid rounded mb-2" style="width: 100%; height: auto; object-fit: cover;">
                </div>
            </div>
        </div>

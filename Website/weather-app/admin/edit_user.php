...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_FILES['avatar']) && $_FILES['avatar']['error'] == 0) {
        ...
        if (!in_array(strtolower($filetype), $allowed)) {
            echo "<script>alert('Only JPG, JPEG, PNG & GIF files are allowed!'); window.location.href='edit_user.php?id=$user_id';</script>";
            exit;
        }
        ...
        if (move_uploaded_file($_FILES['avatar']['tmp_name'], $upload_path . $uniqueName)) {
            ...
            echo "<script>alert('Failed to upload file!'); window.location.href='edit_user.php?id=$user_id';</script>";
            exit;
        }
    }
    ...
    if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
        echo "<script>alert('Invalid email format!'); window.location.href='edit_user.php?id=$user_id';</script>";
        exit;
    }
    ...
    if ($check_result->num_rows > 0) {
        echo "<script>alert('Username or email already exists!'); window.location.href='edit_user.php?id=$user_id';</script>";
        exit;
    }
    ...
    if (!empty($password)) {
        if ($password !== $confirm_password) {
            echo "<script>alert('Passwords do not match!'); window.location.href='edit_user.php?id=$user_id';</script>";
            exit;
        }
    ...
    if ($stmt->execute()) {
        ...
        echo "<script>alert('Error updating user: " . $conn->error . "'); window.location.href='edit_user.php?id=$user_id';</script>";
    }
}
?>
...
<div class="main-content rounded" style="background:#fff; margin-right:1rem; min-height: 70vh; height:auto">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="content-header mb-0">Edit User</h2>
    ...
    <div class="form-container">
        <form method="POST" action="" enctype="multipart/form-data">
            ...
            <div class="form-section text-center">
                ...
                <small class="text-muted mt-2 d-block">Click the pencil icon to change the profile photo</small>
            </div>
